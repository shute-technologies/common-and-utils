...
export type IRFunction1<T, TResult> = (args: T) => TResult;
export type IRFunction2<T0, T1, TResult> = (a0: T0, a1: T1) => TResult;
export type IRFunction3<T0, T1, T2, TResult> = (a0: T0, a1: T1, a2: T2) => TResult;
export type IRFunction4<T0, T1, T2, T3, TResult> = (a0: T0, a1: T1, a2: T2, a3: T3) => TResult;
export type IRFunction5<T0, T1, T2, T3, T4, TResult> = (a0: T0, a1: T1, a2: T2, a3: T3, a4: T4) => TResult;
...
export type IRCallback1<T> = (args: T) => void;
export type IRCallback2<T0, T1> = (a0: T0, a1: T1) => void;
export type IRCallback3<T0, T1, T2> = (a0: T0, a1: T1, a2: T2) => void;
export type IRCallback4<T0, T1, T2, T3> = (a0: T0, a1: T1, a2: T2, a3: T3) => void;
export type IRCallback5<T0, T1, T2, T3, T4> = (a0: T0, a1: T1, a2: T2, a3: T3, a4: T4) => void;
